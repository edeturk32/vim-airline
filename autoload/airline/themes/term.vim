...
let s:N1 = [ '#141413', '#AE682', 15, 6 ] " mode
let s:N2 = [ '#CAE682', '#32322F', 15, 1 ] " info
let s:N3 = [ '#CAE682', '#242424', 0, 15 ] " statusline
let s:N4 = [ '#86CD74', 10 ]                   " mode modified

" Insert mode
let s:I1 = [ '#141413', '#FDE76E', 232, 3 ]
let s:I2 = [ '#FDE76E', '#32322F', 3, 'black' ]
let s:I3 = [ '#FDE76E', '#242424', 0, 15 ]
let s:I4 = [ '#FADE3E', 11 ]

" Visual mode
let s:V1 = [ '#141413', '#B5D3F3', 232, 4 ]
let s:V2 = [ '#B5D3F3', '#32322F', 4, 'black' ]
let s:V3 = [ '#FDE76E', '#242424', 0, 15 ]
let s:V4 = [ '#7CB0E6', 12 ]
...
" Inactive mode
let s:IA = [ '#767676', s:N3[1], 4, s:N3[3], '' ]
